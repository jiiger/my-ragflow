...
#
"""学习版 api/db/runtime_config.py(与官方 v0.24.0 1:1 移植)。

进程级运行时配置:DEBUG / HTTP_PORT / JOB_SERVER_HOST 等启动参数,
由 ragflow_server.py 入口初始化,HTTP 层各模块从这里读。
官方文件:api/db/runtime_config.py@v0.24.0
"""
