...
"""字符串处理工具(与官方 common/string_utils.py 1:1 移植)。

remove_redundant_spaces: 去掉标点旁的多余空格(检索/展示文本清洗用);
clean_markdown_block: 去掉 ```markdown 包裹(LLM 输出解析用)。
官方文件:common/string_utils.py@v0.24.0
"""
import re
