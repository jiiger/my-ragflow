...
#
"""
KGSearch(Dealer 子类):GraphRAG 查询侧。LLM 查询重写 → 实体/关系三路召回(关键词向量/类型/文本) → N-hop 邻居衰减扩展 → pagerank×sim 打分融合 → 子图+社区报告兜底拼文本。全局单例 settings.kg_retriever。移植自官方 v0.24.0 rag/graphrag/search.py。
"""
import asyncio
import json
import logging
