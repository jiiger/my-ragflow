"""
GraphRAG 工具族:GraphChange(待合并图变更)/图序列化(link 列表与邻接互转)/chat_limiter(全局限流信号量)/LLM 缓存(set/get_llm_cache 走 REDIS)/prompt 变量替换/实体类型与 embedding 辅助。移植自官方 v0.24.0 rag/graphrag/utils.py。
"""
