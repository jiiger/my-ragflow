...
#
"""
抽取器基类:Extractor 持有 LLM 调用与错误处理,按 chunk 并发抽取(限流),提供 resolve/records 等通用接口;GraphExtractor/MindMapExtractor 继承它。移植自官方 v0.24.0 rag/graphrag/general/extractor.py。
"""
import asyncio
import logging
import os
