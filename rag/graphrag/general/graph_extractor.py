"""
GeneralKGExt(微软 GraphRAG 原版移植):prompt 变量替换(tuple/record 分隔符),max_gleanings 循环追问漏网实体,logit_bias 强制 YES/NO。移植自官方 v0.24.0 rag/graphrag/general/graph_extractor.py。
"""
