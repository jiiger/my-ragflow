...
#
"""
GraphRAG 索引侧主流程:run_graphrag(文档→子图,light/general 二选一)→merge_subgraph(增量合并进 ES 图谱索引,Redis 分布式锁防并发)→ 可选 resolve_entities(消解)/ extract_community(Leiden+社区报告)/ mind_map。移植自官方 v0.24.0 rag/graphrag/general/index.py。
"""
import asyncio
import json
import logging
